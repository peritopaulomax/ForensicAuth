...
|---|---|---|---|
| 2026-07-04 | Repository Intelligence: atualização Knowledge/Summary/Brain; `.gitignore` reforçado; remoção de `outputs/` e pesos >100 MB do índice Git | Documentation / Ops | `.gitignore`, `knowledge/divergence_report_2026-07-04.md`, `knowledge/audio_spoofing_pipeline.md` |
| 2026-07-03 | Hub multi-detector spoofing áudio: DF Arena 1B, SLS XLS-R, WeDefense WavLM+MHFA | AI / Feature | `core/legacy/audio_spoofing/`, `core/plugins/audio_spoofing_adapter.py`, `AudioSpoofingAnalysis.tsx`, `test_audio_spoofing_multi.py` |
| 2026-07-01 | Calibração LR sintética expandida (bi-Gauss, matrizes score, SAFE 500/500, tiles 4) | AI / Data | `core/synthetic_lr_reference.py`, `outputs/lr_calibration/` (local only) |
