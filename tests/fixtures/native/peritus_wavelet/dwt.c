...
void dwt_allocate(size_t m, size_t n, int ncoeff, double **x_dummy, double **y_dummy_low, double **y_dummy_high, double **coeff_low, double **coeff_high) {
    *x_dummy      = (double *) calloc(max(m,n)+ncoeff-1, sizeof(double));
    *y_dummy_low  = (double *) calloc(max(m,n),          sizeof(double));
    *y_dummy_high = (double *) calloc(max(m,n),          sizeof(double));
    *coeff_low    = (double *) calloc(ncoeff,            sizeof(double));
    *coeff_high   = (double *) calloc(ncoeff,            sizeof(double));
}
 ...
 *
 */
void dwtX(double *x, size_t nrows, size_t ncols, double *h, int ncoeff, int levels, double *y) {
