...
class Detection:
    def __init__(self, detection_model_dir: str = "./resources/detection_model"):
...
class AntiSpoofPredict(Detection):
    def __init__(self, device_id, detection_model_dir: str = "./resources/detection_model"):
        super(AntiSpoofPredict, self).__init__(detection_model_dir)
