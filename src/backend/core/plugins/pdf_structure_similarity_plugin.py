...
from core.legacy.pdf.pdf_structure_similarity import run_similarity_analysis


class PDFStructureSimilarityPlugin(ForensicPlugin):
    @property
    def name(self) -> str:
        return "pdf_structure_similarity"
    ...
    def validate_parameters(self, parameters: Dict[str, Any]) -> Tuple[bool, str]:
        ...
        if mode == "with_reference":
            ...
            return False, "Modo sem referencia exige ao menos 2 PDFs questionados"
    ...
    def analyze(self, evidence_path: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
        tmpdir = job_artifact_dir(parameters, fallback_subdir="pdf_sim_tmp")
