...
_BASE_ARTIFACT_MAPPINGS: list[tuple[str, str]] = [
    ...
    ("enf_overlay_html_path", "enf_overlay.html"),
    ("levels_overlay_html_path", "levels_overlay.html"),
    ("dc_overlay_html_path", "dc_overlay.html"),
    ("ltas_normal_overlay_html_path", "ltas_normal_overlay.html"),
    ("ltas_6db_overlay_html_path", "ltas_6db_overlay.html"),
    ("ltas_sorted_overlay_html_path", "ltas_sorted_overlay.html"),
    ("ltas_derivative_overlay_html_path", "ltas_derivative_overlay.html"),
