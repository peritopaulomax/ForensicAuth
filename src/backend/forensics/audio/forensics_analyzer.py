...
from forensics.audio.spectrogram_decimate import (
    DEFAULT_MAX_FREQ_BINS,
    DEFAULT_MAX_TIME_BINS,
    decimate_spectrogram_max_pool,
)
from forensics.audio.spectrogram_scipy import compute_spectrogram_db, compute_spectrogram_db_from_audio
