...
from forensics.audio_spoofing.embedding_utils import aggregate_embeddings, register_sls_embedding_hook
...
def _load_model(device: torch.device | str | None = None) -> tuple[Any, torch.device]:
    ...
    bootstrap_fairseq()
    from forensics.sls_spoofing.sls_runtime import _vendor_root
