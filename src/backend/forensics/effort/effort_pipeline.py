...
from forensics.effort.effort_model import EffortDetector
from forensics.effort.effort_runtime import (
    CLIP_HF_ID,
...
def infer_effort_from_pil(image: Image.Image, *, variant: str, device: torch.device) -> EffortAnalysisResult:
    from forensics.effort.effort_runtime import EFFORT_VARIANTS
...
def predict_effort_rows(
    ...
    from forensics.effort.effort_runtime import EFFORT_VARIANTS, effort_runtime_status
