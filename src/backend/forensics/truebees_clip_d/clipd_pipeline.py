...
from forensics.truebees_clip_d.clipd_runtime import (
    clipd_config_path,
...
CORVI2023_MODEL_LABEL = "DMimageDetection"
...
def infer_clipd_from_pil(
    ...
    *,
    ...
    from forensics.synthetic_image_detection.embedding_utils import (
        flatten_embedding,
...
def predict_corvi2023_row(image: Image.Image, on_progress: ProgressFn = None) -> list[str] | None:
    ...
    try:
        (llr, _num_tiles, _tiled), device = run_with_device_fallback(
            _run,
            on_fallback=clear_clipd_model_cache,
