...
O codigo do modelo fica em vendor/df_arena_1b. Este modulo adiciona esse
diretorio ao sys.path em tempo de execucao, sincroniza os arquivos .py no
cache do HuggingFace e cria o pipeline sob demanda (lazy loading), sem
carregar o modelo na importacao do modulo.
"""
...
# Codigo de terceiros do DF Arena.
_DF_ARENA_DIR = _workspace_root() / "vendor" / "df_arena_1b"
...
def infer_df_arena_windows(
    ...
    *,
    ...
    Args:
        ...
        device: torch device to use; if None, the DF Arena pipeline selects the default.
