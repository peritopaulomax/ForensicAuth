...
from forensics.copy_move_pca.cpp_sort import std_sort_indices
from forensics.copy_move_pca.numba_kernels import (
    quantize_lex_keys,
    vectorize_blocks,
    vote_displacements,
)
from forensics.copy_move_pca.peritus_mark import build_peritus_colors, mark_peritus_corners

# Legacy subprocess sort fallback (if .so not built)
_SORT_BIN = backend_root() / "lib" / "native" / "copy_move_pca_sort"
