...
from forensics.copy_move_pca.parallel_config import configure_copy_move_parallelism
from forensics.copy_move_pca.reference_cpp import run_copy_move_pca_reference
...
def run_copy_move_pca(
    ...
    _report(on_progress, 10, "Copy-Move PCA")
