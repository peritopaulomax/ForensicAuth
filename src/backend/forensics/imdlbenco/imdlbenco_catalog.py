...
IMDLBENCO_METHODS: tuple[ImdlBencoMethod, ...] = (
    ...
    ImdlBencoMethod(
        ...
        tier="ecosystem",
        description=(
            "APSC-Net (Adaptive Perception + Self-Calibration) do MIML: localizacao "
            "single-image treinada em ~123k edicoes manuais (CVPR 2024)."
        ),
        repo_url="https://github.com/qcf-568/MIML",
        stars=118,
        accent="#9333ea",
        image_size=512,
        use_resizing=True,
