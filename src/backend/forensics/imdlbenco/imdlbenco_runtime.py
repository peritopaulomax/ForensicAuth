...
from forensics.imdlbenco.imdlbenco_catalog import (
    IMDLBENCO_METHODS,
    MethodStatus,
    get_method,
)
...
def _trufor_ready() -> tuple[bool, str]:
    from forensics.imdlbenco.trufor_official_pipeline import official_runtime_ready
...
def method_runtime_status(method_id: str) -> tuple[MethodStatus, str]:
    ...
    if method_id == "miml_apscnet":
        from forensics.imdlbenco.miml_official_pipeline import official_runtime_ready
    ...
    if method_id == "nfa_vit":
        from forensics.imdlbenco.nfa_vit_official_pipeline import official_runtime_ready
    ...
    if method_id == "mesorch":
        from forensics.imdlbenco.mesorch_official_pipeline import official_runtime_ready
    ...
    if method_id == "cat_net":
        from forensics.imdlbenco.cat_net_official_pipeline import official_runtime_ready
