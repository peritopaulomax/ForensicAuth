...
from forensics.imdlbenco.imdlbenco_preprocess import postprocess_mask, preprocess_single_image
...
def run_imdlbenco_analysis(
    ...
    *,
    ...
    if method == "miml_apscnet":
        from forensics.imdlbenco.miml_official_pipeline import run_miml_apscnet_analysis
    ...
    if method == "dinov3_iml":
        from forensics.imdlbenco.dinov3_iml_official_pipeline import run_dinov3_iml_official_analysis
    ...
    if method == "nfa_vit":
        from forensics.imdlbenco.nfa_vit_official_pipeline import run_nfa_vit_official_analysis
    ...
    if method == "co_transformers":
        from forensics.imdlbenco.co_transformers_official_pipeline import (
    ...
    if method == "trufor":
        from forensics.imdlbenco.trufor_official_pipeline import run_trufor_official_analysis
    ...
    if method == "cat_net":
        from forensics.imdlbenco.cat_net_official_pipeline import run_cat_net_official_analysis
    ...
    if method == "mesorch":
        from forensics.imdlbenco.mesorch_official_pipeline import run_mesorch_official_analysis
