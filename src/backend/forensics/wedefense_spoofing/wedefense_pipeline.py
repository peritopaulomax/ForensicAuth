...
def _load_model(device: torch.device | str | None = None) -> tuple[Any, torch.device, dict[str, Any]]:
    ...
    if not config_path.is_file():
        from forensics.wedefense_spoofing.wedefense_runtime import ensure_local_config
...
def infer_wedefense_windows(
    ...
    *,
    ...
    if return_embedding:
        from forensics.audio_spoofing.embedding_utils import aggregate_embeddings
