...
from forensics.safe.safe_runtime import resolve_checkpoint, safe_runtime_status, safe_vendor_dir
...
def _extract_safe_tiles(image: Image.Image, n_tiles: int = 4) -> list[Image.Image]:
    ...
    # Fill remaining tile slots with mid-side crops when the image is large enough.
