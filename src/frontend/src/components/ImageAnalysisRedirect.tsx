...
interface Props {
  /** Slug de rota alias (ex.: `ela`, `image_metadata`). */
  slug?: string;
  /** ID do método IMDL (rota `/analysis/imdl/:methodId`). */
  methodId?: string;
}

/** Redireciona aliases de análise de imagem para o grupo correspondente. */
export default function ImageAnalysisRedirect({ slug, methodId: methodIdProp }: Props) {
