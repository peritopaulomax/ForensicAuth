...
const videoTechniques: TechniqueConfig[] = [
  ...
  { id: "videofact", mediaType: "video", template: "medium", component: VideoFactAnalysis, meta: FORENSIC_TECHNIQUE_META.videofact, gpu: true },
  { id: "stil_video_detection", mediaType: "video", template: "simple", component: StilVideoAnalysis, meta: FORENSIC_TECHNIQUE_META.stil_video_detection, gpu: true },
  { id: "lowres_fake_video", mediaType: "video", template: "simple", component: LowResFakeVideoAnalysis, meta: FORENSIC_TECHNIQUE_META.lowres_fake_video, gpu: true },
  { id: "truvil", mediaType: "video", template: "simple", component: TruVilAnalysis, meta: FORENSIC_TECHNIQUE_META.truvil, gpu: true },
  { id: "vilocal", mediaType: "video", template: "simple", component: ViLocalAnalysis, meta: FORENSIC_TECHNIQUE_META.vilocal, gpu: true },
  {
    id: "isomedia_parser",
    mediaType: "video",
    template: "complex",
