...
const _BASE_FORENSIC_TECHNIQUE_META: Record<string, ForensicTechniqueMeta> = {
  ...
  synthetic_image_detection: {
    ...
    citation:
      "Modelos Hugging Face: haywoodsloan/ai-image-detector-deploy; cmckinle/sdxl-flux-detector_v1.1.\n\n" +
    ...
    detail:
      "Meta classificador com estratégia para cálculo de LR utilizando método de calibração bigaussiana, por população de referência.",
    summary:
      "Selecione detectores e subgrupos de população de referência. Seleção de população de referência default sugerida. Artefatos: scores individuais, gráficos Tippett/distribuição LR.",
