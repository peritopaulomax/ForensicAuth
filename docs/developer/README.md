# Documentação para desenvolvedores — ForensicAuth

Este diretório complementa as **especificações formais** em [`docs/specs/`](../specs/) com material orientado a quem precisa **entender, explicar ou contribuir** com o código.
...
**Ambiente:** conda `forensicauth`, Python 3.11+, Node 18+ para o frontend.
